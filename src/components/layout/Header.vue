	...
	<div class="hwrap">
		<header>
			<div class="inner">
				...
				<div class="right">
					<div class="bx_search">
						<input type="text" placeholder="종목명 또는 종목코드를 입력하십시오."/>
		...
		<nav class="gnb" @mouseleave="offMenu">
			<ul class="inner">
				<li>
					<strong class="menu" @mouseover="onMenu">섹터/테마 기술랭킹</strong>
					<ul class="dep">
						<li><router-link to="/sectorRanking" class="smenu">섹터분석</router-link></li>
						<li><router-link to="/themeRanking" class="smenu">테마분석</router-link></li>
					</ul>
				</li>
				<li>
					<strong class="menu" @mouseover="onMenu">투자마이닝</strong>
					<ul class="dep">
				...
				<li>
					<strong class="menu" @mouseover="onMenu">AI기술종목분석</strong>
					<ul class="dep">
						<li><router-link to="/ready" class="smenu">추천 종목분석</router-link></li>
					</ul>
				</li>
				<li>
					<strong class="menu" @mouseover="onMenu">매매신호서비스</strong>
					<ul class="dep">
						<li><router-link to="/ready" class="smenu">기술기반 매매신호</router-link></li>
					</ul>
				</li>
				<li>
					<strong class="menu" @mouseover="onMenu">테마포착</strong>
					<ul class="dep">
